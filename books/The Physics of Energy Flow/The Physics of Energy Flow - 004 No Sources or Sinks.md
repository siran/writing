...
not whether energy moves from one region to a neighboring region, but what shape
the reorganization of energy takes when understood as a complete process rather
than region by region numerical accounting. Although $\mathbf{S}$ handles a
directional accounting of how energy is transported, even taken as a whole it
does not yet reveal the structure of that transport, as the next chapters will
show.
