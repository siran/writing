...
kind: preface
part: Front Matter
summary: Interaction implies a shared substrate, identified here as energy. The Preface frames the program by treating the observed effects of energy redistribution as evidence of continuous flow and by asking what must follow if something exists and redistributes continuously.
keywords:
  - shared substrate
  - energy
  - continuous flow
