...
two-aspect transport of the probe. Appendix 212 develops the same weak-field
summary into the full static benchmark set: redshift, Shapiro delay, and
perihelion precession as well as light bending. Those appendices treat the
...
Appendices 215 and 216 make explicit why the factor of two belongs to the
