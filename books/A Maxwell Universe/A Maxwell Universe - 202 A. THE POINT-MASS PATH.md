...
## Geometry Before and the Point-Mass

### The ancients

Geometry is ancient. Long before physics existed as a discipline, geometric
relationships were studied as ideal objects: perfect lines, circles, and
proportions. By the time of Euclid (~300 BCE), geometry had become a formal
deductive system: abstract, exact, and independent of the physical world's
imperfections.

Even today we still debate whether numbers “exist,” or whether a perfect circle
is real or only an idea.


### Plato

Plato considered geometry to exist in a “higher realm,” with the physical world
only approximating its purity. As he wrote, “the objects of geometry are eternal
and unchanging” (*Republic* 510d–511a), and the visible world contains only
“images and shadows of the true” (*Republic* 596a). Whether an idea is “real” we
cannot prove, but we can certainly approximate these ideas using events.

Humans routinely identify geometric patterns in random stimuli; this is well
documented in Gestalt psychology, which shows our strong bias to impose simple
geometric structure on ambiguous input (Wagemans et al., *Annual Review of
Psychology*, 2012).

For Plato, geometry belonged to a realm more real than the material world.
Physical objects were degraded projections of perfect mathematical relations. In
this view, geometry is not derived from the world; the world participates in
geometry.


### Descartes

Descartes accepted the ancient notion of geometry as an abstract structure, but
introduced a powerful new tool: the idea of coordinate systems that allowed
geometry to be expressed symbolically and manipulated algebraically. A curve
could now be described by an equation; geometry translated into numbers.

For example:


> A circle of radius \(r\) centered at the origin is described by \(x^2 + y^2 =
> r^2\).
...
(*Principles of Philosophy*, II, §10), and therefore “there can be no such thing
as a vacuum” (*Principles*, II, §16).

Geometry, for Descartes, describes extension itself rather than a background
that exists even when bodies do not.
