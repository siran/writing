...
$$
define the enclosed energy of the self-sustaining electromagnetic configuration, and its energy centroid
...
$$
\frac{d\vec{R}}{dt}
=\frac{1}{U}\frac{d}{dt}\int_V \vec{r}\,u\,d^3x-\frac{\dot U}{U}\vec{R}.
$$

For a self-confined configuration $\dot U= -\oint_{\partial V}\vec S\cdot d\vec A=0$, hence
$$
\frac{d\vec{R}}{dt}
...
Let a closed surface $\partial V$ define a self-sustained electromagnetic
configuration, and let
$$
U=\int_V u\,d^3x
$$
denote the electromagnetic energy enclosed by that surface. In the absence of
external fields, $\partial V$ defines the surface of the object itself.

Define the inertial mass associated with the configuration by
$$
m=\frac{U}{c^{2}}.
$$

From the exact field-theoretic identity
$$
\vec{P}=\frac{U}{c^{2}}\,\vec{v},
\qquad
\vec{v}=\frac{d\vec{R}}{dt},
$$
differentiation yields the general momentum-balance law
$$
\vec{F}_{\text{ext}}
=\frac{d\vec{P}}{dt}
=\frac{1}{c^{2}}\frac{dU}{dt}\,\vec{v}
...
This relation is exact. It expresses how electromagnetic stress redistributes
both energy and momentum within the bounded configuration.

For a closed, self-sustained electromagnetic structure,
$$
\frac{dU}{dt}=0,
$$
and the relation reduces identically to
$$
\vec{F}_{\text{ext}}=m\,\vec{a}.
$$

Newton’s second law is therefore not a fundamental axiom. It is the special case
of electromagnetic momentum conservation for a configuration whose enclosed
energy remains constant in time.
