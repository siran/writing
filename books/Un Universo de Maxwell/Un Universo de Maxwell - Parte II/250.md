...
excited hydrogen atoms, formalized empirically by Johannes Rydberg in 1888.
...
The standard explanation, developed by Bohr and later Schrödinger, ties this
scaling to the electrostatic interaction between an electron and a proton,
reminiscent of a planetary view. In this picture, larger $n$ corresponds to
the electron occupying an orbit farther from the nucleus.
