    ...
    for it in items_sorted:
        ...
        if it.is_dir:
            ...
            if ext in MD_EXTS:
                ...
                # PDF link: prefer local generated PDF, then .pdf marker (even if
                # PDF not yet rendered — link points to expected path, may 404 until
                # podman runs), then provenance URL.
