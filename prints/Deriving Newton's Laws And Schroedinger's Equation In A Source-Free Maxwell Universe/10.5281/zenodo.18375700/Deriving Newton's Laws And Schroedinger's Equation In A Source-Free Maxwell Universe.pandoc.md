...
<li><a href="#assumptions-and-definitions">Assumptions and definitions</a>
</li>
<li><a href="#part-i-energy-continuity-is-exact">Part I — Energy continuity is exact</a>
</li>
<li><a href="#part-ii-momentum-continuity-is-exact">Part II — Momentum continuity is exact</a>
</li>
<li><a href="#part-iii-angular-momentum-continuity-is-exact">Part III — Angular momentum continuity is exact</a>
</li>
<li><a href="#part-iv-newton-like-laws-for-a-localized-electromagnetic-knot">Part IV — Newton-like laws for a localized electromagnetic knot</a>
</li>
<li><a href="#part-v-schrdinger-dynamics-as-a-narrow-band-maxwell-envelope">Part V — Schrödinger dynamics as a narrow-band Maxwell envelope</a>
</li>
